...
for log_id in log_list:
    ...
    if not os.path.exists(os.path.join(root_folder, log_id)):
        print(f'{log_id} does not exist')
        continue
    # if os.path.exists(os.path.join(root_folder, log_id, "Satellite_Images")):
    #     print(f'{log_id} has satellite images')
    #     continue
    # else:
    #     print(f'{log_id} processing')
