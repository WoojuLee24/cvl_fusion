...
if __name__ == '__main__':
    ...
    # # Ours
    # dataset_name = 'kitti3_1' # Ours
    # ckpt = '/ws/external/outputs/training/KITTI3/3dv2.3_p5000.10000_iters5_reproj_mask.none_ver1.02_zsn3_t20_r15/checkpoint_best.tar'

    # LM
    dataset_name = 'kitti2_1' # LM
    ckpt = '/ws/external/outputs/training/KITTI2/LM/p5000_iters5_t20_r15/checkpoint_best.tar'
    ...
    if dataset_name == 'ford':
        ...
        test_loader = dataset.get_data_loader('test', shuffle=False)
    elif dataset_name == 'kitti3_1':
        from pixloc.pixlib.datasets.kitti3_1 import Kitti
        dataset = Kitti(data_conf)
        test_loader = dataset.get_data_loader('test', shuffle=False)
    elif dataset_name == 'kitti2_1':
        from pixloc.pixlib.datasets.kitti2_1 import Kitti
        dataset = Kitti(data_conf)
        test_loader = dataset.get_data_loader('test', shuffle=False)
